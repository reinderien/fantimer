...
dims = (Var('w', value=2*pi*60),         # angular velocity, rad/s
        ...
        Var('R2', precision=24, vmin=('Vrc2/Imax',     # Limit opto discharged I
                                      'Vrc2**2/Prp'),  # Limit res pulse P
                                vmax=('Vrc2/I - 1',    # Turn on opto
                                      'Prp/Imax**2',   # Limit res pulse P
                                      'Pr/I**2')),     # Limit res continous P

        Var('C2', precision=12, value='1/w/sqrt(Zz**2 - (R2 + Rd)**2)'),
        Var('Xc2', value='1/w/C2'),
        Var('ImVz', value='I*Xc2'),

        Var('R1', precision=24, vmin=('Vrc1/Imax',     # Limit opto discharged I
                                      'Vrc1**2/Prp'),  # Limit res pulse P
